.PHONY: all clean scratch # put all phony target at the top
...
# report
report/count_report.html: report/count_report.qmd results/figure/isles.png results/figure/abyss.png results/figure/last.png results/figure/last.png
